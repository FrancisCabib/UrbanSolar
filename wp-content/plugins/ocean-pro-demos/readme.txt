...
= 1.4.5 - MAY 23 2023 =
- Added: Compatibility: PHP 8.2.6: Creation of dynamic property Ocean_Pro_Demos::$plugin_path and Ocean_Pro_Demos::$plugin_url is deprecated.

= 1.4.4 - Mar 29 2023 =
- Fixed: CSS selector styling influencing WooCommerce product type selection (on rare occasions).

= 1.4.3 - Mar 15 2023 =
- NEW: Flaticon icons import: Stickers support.
- Added: Freepik API v3 changes.
...
= 1.3.0 =
- Added: Freepik and Flaticon API support for Business and Agency plans. Navigate to Theme Panel > Ocean Images to enable, then find a new option below the Media in your WordPress dashboard.

= 1.2.2 =
- Added: New Gutenberg demo, Sushi: https://gsushi.oceanwp.org/
- Added: New Gutenberg demo, Nutritionist: https://gnutritionist.oceanwp.org/
- Added: New Gutenberg demo, Clothes: https://gclothes.oceanwp.org/
- Added: New Gutenberg demo, Games: https://ggames.oceanwp.org/
- Added: New Gutenberg demo, Barbecue: https://gbarbecue.oceanwp.org/
- Added: New Gutenberg demo, My Nails: https://gmynails.oceanwp.org/
- Added: New Gutenberg demo, Toys: https://gtoys.oceanwp.org/
- Added: New Gutenberg demo, Pet: https://gpet.oceanwp.org/
- Added: New Gutenberg demo, Earphone: https://gearphone.oceanwp.org/
- Added: New Gutenberg demo, Cap: https://gcap.oceanwp.org/
- Added: New Gutenberg demo, Croquette: https://gcroquette.oceanwp.org/
- Added: New Gutenberg demo, Pumps: https://gpumps.oceanwp.org/
- Added: New Gutenberg demo, Backpack: https://gbackpack.oceanwp.org/
- Added: New Gutenberg demo, Essential: https://gessential.oceanwp.org/
- Added: New Gutenberg demo, Basket: https://gbasket.oceanwp.org/
- Added: New Gutenberg demo, Out: https://gout.oceanwp.org/
- Added: New Gutenberg demo, Agenda: https://gagenda.oceanwp.org/
- Added: New Gutenberg demo, Teddy: https://gteddy.oceanwp.org/
- Added: New Gutenberg demo, Rings: https://grings.oceanwp.org/
- Added: New Gutenberg demo, Coaching: https://gcoaching.oceanwp.org/
- Added: New HubSpot demo, Delicious: https://hdelicious.oceanwp.org/
- Added: New HubSpot demo, Digital: https://hdigital.oceanwp.org/
- Added: New HubSpot demo, Designer: https://hdesigner.oceanwp.org/
- Added: New HubSpot demo, Agency: https://hagency.oceanwp.org/
- Added: New HubSpot demo, Corporate: https://hcorporate.oceanwp.org/
...
= 1.2.0 =
- Added: New demo, Fountain: https://fountain.oceanwp.org/
- Added: New demo, Picture: https://picture.oceanwp.org/
- Added: New demo, Phone: https://phone.oceanwp.org/
- Added: New demo, Knife: https://knife.oceanwp.org/
- Added: New demo, Scents: https://scents.oceanwp.org/
- Added: New demo, Buoy: https://buoy.oceanwp.org/
- Added: New demo, Spice: https://spice.oceanwp.org/
- Added: New demo, Agenda: https://agenda.oceanwp.org/
- Added: New demo, Egg: https://egg.oceanwp.org/
- Added: New demo, Essential: https://essential.oceanwp.org/
- Added: New demo, Diffusers: https://diffusers.oceanwp.org/
- Added: New demo, Games: https://games.oceanwp.org/
- Added: New demo, Teddy: https://teddy.oceanwp.org/
- Added: New demo, Croquette: https://croquette.oceanwp.org/
- Added: New demo, Nail: https://nail.oceanwp.org/
- Added: New demo, Statue: https://statue.oceanwp.org/
- Added: New demo, Boat: https://boat.oceanwp.org/
- Added: New demo, Rings: https://rings.oceanwp.org/
- Added: New demo, Towel: https://towel.oceanwp.org/
- Added: New demo, Backpack: https://backpack.oceanwp.org/

= 1.1.9 =
- Added: New demo, Basket: https://basket.oceanwp.org/
